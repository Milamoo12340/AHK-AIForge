...
import { Loader2, Sparkles, Download, Terminal, Play } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Describe what you want your AutoHotkey script to do.{" "}
          <span className="text-xs opacity-60">Ctrl+Enter to generate</span>
        </p>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-card rounded-xl p-6 border border-border shadow-sm space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                placeholder="E.g., Create a PS99 auto-hatch macro that holds F and clicks every 0.5s, stops on Escape."
            ...
            <div className="pt-4 border-t border-border/50">
              <details className="text-sm text-muted-foreground">
                <summary className="cursor-pointer hover:text-primary transition-colors">
                  Advanced: Use custom OpenAI Key
                </summary>
                <div className="mt-3">
                  <input
                    type="password"
                  ...
                  <p className="text-xs mt-1 text-muted-foreground/80">
                    Leave blank to use the built-in system key.
                  </p>
                </div>
              </details>
            </div>
          ...
          <AnimatePresence mode="wait">
            {generatedScript ? (
              ...
              >
                ...
                <div className="p-4 rounded-lg bg-secondary/30 border border-border/50">
                  ...
                  <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                    ...
                    <li>Right-click → Run as administrator if it needs elevated access</li>
                  </ol>
                </div>
              </motion.div>
            ) : isPending ? (
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 bg-card/30 rounded-xl border border-border/50 border-dashed"
              >
                ...
                <div className="text-muted-foreground h-6">
                  <TypewriterEffect
                    text="Designing logic flow... Writing hotkey definitions... Optimizing syntax..."
                    speed={50}
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground max-w-xs mt-2">
                  Enter your requirements on the left and I will generate the AutoHotkey script for you instantly.
                </p>
              </motion.div>
            )}
          </AnimatePresence>
